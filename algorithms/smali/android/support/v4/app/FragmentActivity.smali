...
.field mPendingFragmentActivityResults:Landroid/support/v4/g/s;
...
.field private mViewModelStore:Landroid/arch/lifecycle/ab;
...
.method private allocateRequestIndex(Landroid/support/v4/app/Fragment;)I
    ...
    .line 863
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->mPendingFragmentActivityResults:Landroid/support/v4/g/s;

    invoke-virtual {v0}, Landroid/support/v4/g/s;->b()I
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/g/s;->f(I)I
    ...
    .line 874
    iget-object v2, p0, Landroid/support/v4/app/FragmentActivity;->mPendingFragmentActivityResults:Landroid/support/v4/g/s;

    iget-object p1, p1, Landroid/support/v4/app/Fragment;->mWho:Ljava/lang/String;

    invoke-virtual {v2, v0, p1}, Landroid/support/v4/g/s;->b(ILjava/lang/Object;)V
...
.method private markFragmentsCreated()V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/app/FragmentActivity;->markState(Landroid/support/v4/app/FragmentManager;Landroid/arch/lifecycle/h;)Z
...
.method private static markState(Landroid/support/v4/app/FragmentManager;Landroid/arch/lifecycle/h;)Z
    .locals 4
    ...
    .line 1006
    :cond_1
    invoke-virtual {v1}, Landroid/support/v4/app/Fragment;->getLifecycle()Landroid/arch/lifecycle/f;

    move-result-object v2

    invoke-virtual {v2}, Landroid/arch/lifecycle/f;->a()Landroid/arch/lifecycle/h;

    move-result-object v2

    sget-object v3, Landroid/arch/lifecycle/h;->d:Landroid/arch/lifecycle/h;

    invoke-virtual {v2, v3}, Landroid/arch/lifecycle/h;->a(Landroid/arch/lifecycle/h;)Z
    ...
    .line 1007
    iget-object v0, v1, Landroid/support/v4/app/Fragment;->mLifecycleRegistry:Landroid/arch/lifecycle/k;

    invoke-virtual {v0, p1}, Landroid/arch/lifecycle/k;->a(Landroid/arch/lifecycle/h;)V
    ...
    .line 1013
    invoke-static {v1, p1}, Landroid/support/v4/app/FragmentActivity;->markState(Landroid/support/v4/app/FragmentManager;Landroid/arch/lifecycle/h;)Z
...
.method public getLifecycle()Landroid/arch/lifecycle/f;
    ...
    .line 310
    invoke-super {p0}, Landroid/support/v4/app/BaseFragmentActivityApi16;->getLifecycle()Landroid/arch/lifecycle/f;
...
.method public getSupportLoaderManager()Landroid/support/v4/app/LoaderManager;
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/FragmentActivity;->getViewModelStore()Landroid/arch/lifecycle/ab;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Landroid/support/v4/app/LoaderManagerImpl;-><init>(Landroid/arch/lifecycle/j;Landroid/arch/lifecycle/ab;)V
...
.method public getViewModelStore()Landroid/arch/lifecycle/ab;
    .locals 2
    ...
    .line 297
    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/FragmentActivity;->mViewModelStore:Landroid/arch/lifecycle/ab;
    ...
    invoke-direct {v0}, Landroid/arch/lifecycle/ab;-><init>()V

    iput-object v0, p0, Landroid/support/v4/app/FragmentActivity;->mViewModelStore:Landroid/arch/lifecycle/ab;
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 146
    iget-object v1, p0, Landroid/support/v4/app/FragmentActivity;->mPendingFragmentActivityResults:Landroid/support/v4/g/s;

    invoke-virtual {v1, v0}, Landroid/support/v4/g/s;->a(I)Ljava/lang/Object;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/g/s;->c(I)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 326
    iget-object v2, v0, Landroid/support/v4/app/FragmentActivity$NonConfigurationInstances;->viewModelStore:Landroid/arch/lifecycle/ab;

    iput-object v2, p0, Landroid/support/v4/app/FragmentActivity;->mViewModelStore:Landroid/arch/lifecycle/ab;
    ...
    invoke-direct {v1, v3}, Landroid/support/v4/g/s;-><init>(I)V

    iput-object v1, p0, Landroid/support/v4/app/FragmentActivity;->mPendingFragmentActivityResults:Landroid/support/v4/g/s;
    ...
    .line 344
    iget-object v3, p0, Landroid/support/v4/app/FragmentActivity;->mPendingFragmentActivityResults:Landroid/support/v4/g/s;

    aget v4, v0, v1

    aget-object v5, p1, v1

    invoke-virtual {v3, v4, v5}, Landroid/support/v4/g/s;->b(ILjava/lang/Object;)V
    ...
    .line 350
    :cond_4
    iget-object p1, p0, Landroid/support/v4/app/FragmentActivity;->mPendingFragmentActivityResults:Landroid/support/v4/g/s;

    if-nez p1, :cond_5

    .line 351
    new-instance p1, Landroid/support/v4/g/s;

    invoke-direct {p1}, Landroid/support/v4/g/s;-><init>()V

    iput-object p1, p0, Landroid/support/v4/app/FragmentActivity;->mPendingFragmentActivityResults:Landroid/support/v4/g/s;
...
.method public onRequestPermissionsResult(I[Ljava/lang/String;[I)V
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/g/s;->a(I)Ljava/lang/Object;
    ...
    invoke-virtual {v3, v0}, Landroid/support/v4/g/s;->c(I)V
...
.method public final onRetainNonConfigurationInstance()Ljava/lang/Object;
    ...
    .line 548
    iget-object v2, p0, Landroid/support/v4/app/FragmentActivity;->mViewModelStore:Landroid/arch/lifecycle/ab;
    ...
    iput-object v0, v2, Landroid/support/v4/app/FragmentActivity$NonConfigurationInstances;->viewModelStore:Landroid/arch/lifecycle/ab;
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v1}, Landroid/support/v4/g/s;->b()I
    ...
    invoke-virtual {v3}, Landroid/support/v4/g/s;->b()I
    ...
    invoke-virtual {v3, v2}, Landroid/support/v4/g/s;->d(I)I
    ...
    invoke-virtual {v3, v2}, Landroid/support/v4/g/s;->e(I)Ljava/lang/Object;
