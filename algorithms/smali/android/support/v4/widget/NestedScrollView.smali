...
# static fields
.field private static final w:Landroid/support/v4/widget/ab;
...
.field private B:Landroid/support/v4/widget/ac;
...
.field private final z:Landroid/support/v4/view/u;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/NestedScrollView;->w:Landroid/support/v4/widget/ab;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->y:Landroid/support/v4/view/x;

    .line 208
    new-instance p1, Landroid/support/v4/view/u;

    invoke-direct {p1, p0}, Landroid/support/v4/view/u;-><init>(Landroid/view/View;)V

    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->z:Landroid/support/v4/view/u;

    .line 211
    invoke-virtual {p0, v0}, Landroid/support/v4/widget/NestedScrollView;->setNestedScrollingEnabled(Z)V

    .line 213
    sget-object p1, Landroid/support/v4/widget/NestedScrollView;->w:Landroid/support/v4/widget/ab;

    invoke-static {p0, p1}, Landroid/support/v4/view/ab;->a(Landroid/view/View;Landroid/support/v4/view/b;)V
...
.method public a(I)V
    ...
    .line 245
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->z:Landroid/support/v4/view/u;

    invoke-virtual {v0, p1}, Landroid/support/v4/view/u;->c(I)V
...
.method public computeScroll()V
    ...
    .line 1493
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/ab;->a(Landroid/view/View;)V
...
.method public hasNestedScrollingParent()Z
    ...
    invoke-virtual {v0}, Landroid/support/v4/view/u;->b()Z
...
.method protected onScrollChanged(IIII)V
    ...
    .line 509
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->B:Landroid/support/v4/widget/ac;

    if-eqz v0, :cond_0

    .line 510
    iget-object v1, p0, Landroid/support/v4/widget/NestedScrollView;->B:Landroid/support/v4/widget/ac;
    ...
    invoke-interface/range {v1 .. v6}, Landroid/support/v4/widget/ac;->onScrollChange(Landroid/support/v4/widget/NestedScrollView;IIII)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 848
    invoke-static {v0, v1, v2}, Landroid/support/v4/widget/s;->a(Landroid/widget/EdgeEffect;FF)V
    ...
    .line 854
    invoke-static {v0, v1, v3}, Landroid/support/v4/widget/s;->a(Landroid/widget/EdgeEffect;FF)V
...
.method public setOnScrollChangeListener(Landroid/support/v4/widget/ac;)V
    .locals 0

    .line 449
    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->B:Landroid/support/v4/widget/ac;
...
.method public startNestedScroll(I)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/view/u;->b(I)Z
...
.method public stopNestedScroll()V
    ...
    invoke-virtual {v0}, Landroid/support/v4/view/u;->c()V
