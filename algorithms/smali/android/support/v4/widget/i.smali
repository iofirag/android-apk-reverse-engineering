...
.method public a(Ljava/lang/CharSequence;)Landroid/database/Cursor;
    ...
    .line 420
    :cond_0
    iget-object p1, p0, Landroid/support/v4/widget/i;->c:Landroid/database/Cursor;
...
.method a(Landroid/content/Context;Landroid/database/Cursor;I)V
    ...
    .line 178
    iput-boolean v2, p0, Landroid/support/v4/widget/i;->b:Z
    ...
    :goto_1
    iput p1, p0, Landroid/support/v4/widget/i;->e:I
    ...
    invoke-direct {p1, p0}, Landroid/support/v4/widget/j;-><init>(Landroid/support/v4/widget/i;)V

    iput-object p1, p0, Landroid/support/v4/widget/i;->f:Landroid/support/v4/widget/j;

    .line 189
    new-instance p1, Landroid/support/v4/widget/k;

    invoke-direct {p1, p0}, Landroid/support/v4/widget/k;-><init>(Landroid/support/v4/widget/i;)V

    iput-object p1, p0, Landroid/support/v4/widget/i;->g:Landroid/database/DataSetObserver;
    ...
    .line 196
    iget-object p1, p0, Landroid/support/v4/widget/i;->f:Landroid/support/v4/widget/j;
    ...
    .line 197
    :cond_4
    iget-object p1, p0, Landroid/support/v4/widget/i;->g:Landroid/database/DataSetObserver;
...
.method public b(Landroid/database/Cursor;)Landroid/database/Cursor;
    ...
    .line 363
    iput-boolean p1, p0, Landroid/support/v4/widget/i;->a:Z
...
.method public getDropDownView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 283
    iget-object p1, p0, Landroid/support/v4/widget/i;->d:Landroid/content/Context;

    iget-object p2, p0, Landroid/support/v4/widget/i;->c:Landroid/database/Cursor;

    invoke-virtual {p0, p1, p2, p3}, Landroid/support/v4/widget/i;->b(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object p3, p0, Landroid/support/v4/widget/i;->c:Landroid/database/Cursor;

    invoke-virtual {p0, p2, p1, p3}, Landroid/support/v4/widget/i;->a(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
...
.method public getItemId(I)J
    ...
    iget v0, p0, Landroid/support/v4/widget/i;->e:I
