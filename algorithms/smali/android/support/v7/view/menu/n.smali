...
.method public constructor <init>(Landroid/support/v7/view/menu/m;)V
    ...
    .line 231
    iput p1, p0, Landroid/support/v7/view/menu/n;->b:I

    .line 234
    invoke-virtual {p0}, Landroid/support/v7/view/menu/n;->a()V
...
# virtual methods
.method public a(I)Landroid/support/v7/view/menu/t;
    .locals 2
...
.method a()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/p;->r()Landroid/support/v7/view/menu/t;
    ...
    iget-object v1, v1, Landroid/support/v7/view/menu/m;->c:Landroid/support/v7/view/menu/p;

    invoke-virtual {v1}, Landroid/support/v7/view/menu/p;->l()Ljava/util/ArrayList;
    ...
    .line 283
    iput v3, p0, Landroid/support/v7/view/menu/n;->b:I
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 267
    iget-object p2, p0, Landroid/support/v7/view/menu/n;->a:Landroid/support/v7/view/menu/m;

    iget-object p2, p2, Landroid/support/v7/view/menu/m;->b:Landroid/view/LayoutInflater;
    ...
    check-cast p3, Landroid/support/v7/view/menu/ai;
    ...
    invoke-interface {p3, p1, v0}, Landroid/support/v7/view/menu/ai;->a(Landroid/support/v7/view/menu/t;I)V
