...
.field listMenuPresenter:Landroid/support/v7/view/menu/m;

.field listPresenterContext:Landroid/content/Context;

.field menu:Landroid/support/v7/view/menu/p;
...
.method applyFrozenState()V
    ...
    .line 2068
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->menu:Landroid/support/v7/view/menu/p;
...
.method public clearMenuPresenters()V
    ...
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->listMenuPresenter:Landroid/support/v7/view/menu/m;
    ...
    .line 1982
    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->listMenuPresenter:Landroid/support/v7/view/menu/m;

    return-void
.end method

.method getListMenuView(Landroid/support/v7/view/menu/ag;)Landroid/support/v7/view/menu/ah;
    .locals 3
    ...
    .line 2032
    :cond_0
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->listMenuPresenter:Landroid/support/v7/view/menu/m;
    ...
    invoke-direct {v0, v1, v2}, Landroid/support/v7/view/menu/m;-><init>(Landroid/content/Context;I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/view/menu/m;->a(Landroid/support/v7/view/menu/ag;)V

    .line 2036
    iget-object p1, p0, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->menu:Landroid/support/v7/view/menu/p;
    ...
    .line 2039
    :cond_1
    iget-object p1, p0, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->listMenuPresenter:Landroid/support/v7/view/menu/m;

    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->decorView:Landroid/view/ViewGroup;

    invoke-virtual {p1, v0}, Landroid/support/v7/view/menu/m;->a(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/ah;
...
.method onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .line 2049
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->menu:Landroid/support/v7/view/menu/p;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/view/menu/p;->a(Landroid/os/Bundle;)V

    :cond_0
    return-object v0
.end method

.method setMenu(Landroid/support/v7/view/menu/p;)V
    .locals 2
    ...
    .line 2023
    :cond_1
    iput-object p1, p0, Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;->menu:Landroid/support/v7/view/menu/p;
...
.method setStyle(Landroid/content/Context;)V
    ...
    .line 2001
    :cond_1
    sget v0, Landroid/support/v7/a/j;->Theme_AppCompat_CompactMenu:I
    ...
    .line 2009
    sget-object p1, Landroid/support/v7/a/k;->AppCompatTheme:[I
    ...
    .line 2010
    sget v0, Landroid/support/v7/a/k;->AppCompatTheme_panelBackground:I
    ...
    .line 2012
    sget v0, Landroid/support/v7/a/k;->AppCompatTheme_android_windowAnimationStyle:I
