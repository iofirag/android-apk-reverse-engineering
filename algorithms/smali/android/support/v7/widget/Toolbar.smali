...
.field private final H:Landroid/support/v7/widget/w;

.field private I:Landroid/support/v7/widget/ds;

.field private J:Landroid/support/v7/widget/ActionMenuPresenter;

.field private K:Landroid/support/v7/widget/do;

.field private L:Landroid/support/v7/view/menu/ag;

.field private M:Landroid/support/v7/view/menu/q;
...
.field d:Landroid/support/v7/widget/dq;
...
.field private u:Landroid/support/v7/widget/cp;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 198
    new-instance p1, Landroid/support/v7/widget/dl;

    invoke-direct {p1, p0}, Landroid/support/v7/widget/dl;-><init>(Landroid/support/v7/widget/Toolbar;)V

    iput-object p1, p0, Landroid/support/v7/widget/Toolbar;->H:Landroid/support/v7/widget/w;

    .line 217
    new-instance p1, Landroid/support/v7/widget/dm;

    invoke-direct {p1, p0}, Landroid/support/v7/widget/dm;-><init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    sget-object v0, Landroid/support/v7/a/k;->Toolbar:[I
    ...
    .line 238
    sget p2, Landroid/support/v7/a/k;->Toolbar_titleTextAppearance:I

    invoke-virtual {p1, p2, v1}, Landroid/support/v7/widget/dk;->g(II)I
    ...
    .line 239
    sget p2, Landroid/support/v7/a/k;->Toolbar_subtitleTextAppearance:I
    ...
    .line 240
    sget p2, Landroid/support/v7/a/k;->Toolbar_android_gravity:I

    iget p3, p0, Landroid/support/v7/widget/Toolbar;->x:I

    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/dk;->c(II)I
    ...
    .line 241
    sget p2, Landroid/support/v7/a/k;->Toolbar_buttonGravity:I
    ...
    .line 244
    sget p2, Landroid/support/v7/a/k;->Toolbar_titleMargin:I

    invoke-virtual {p1, p2, v1}, Landroid/support/v7/widget/dk;->d(II)I

    move-result p2

    .line 245
    sget p3, Landroid/support/v7/a/k;->Toolbar_titleMargins:I

    invoke-virtual {p1, p3}, Landroid/support/v7/widget/dk;->g(I)Z
    ...
    invoke-virtual {p1, p3, p2}, Landroid/support/v7/widget/dk;->d(II)I
    ...
    .line 251
    sget p2, Landroid/support/v7/a/k;->Toolbar_titleMarginStart:I

    const/4 p3, -0x1

    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/dk;->d(II)I
    ...
    .line 256
    :cond_1
    sget p2, Landroid/support/v7/a/k;->Toolbar_titleMarginEnd:I
    ...
    .line 261
    :cond_2
    sget p2, Landroid/support/v7/a/k;->Toolbar_titleMarginTop:I
    ...
    .line 266
    :cond_3
    sget p2, Landroid/support/v7/a/k;->Toolbar_titleMarginBottom:I
    ...
    .line 272
    :cond_4
    sget p2, Landroid/support/v7/a/k;->Toolbar_maxButtonHeight:I

    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/dk;->e(II)I
    ...
    .line 274
    sget p2, Landroid/support/v7/a/k;->Toolbar_contentInsetStart:I

    const/high16 v0, -0x80000000

    .line 275
    invoke-virtual {p1, p2, v0}, Landroid/support/v7/widget/dk;->d(II)I
    ...
    .line 278
    invoke-virtual {p1, v2, v0}, Landroid/support/v7/widget/dk;->d(II)I
    ...
    .line 281
    invoke-virtual {p1, v3, v1}, Landroid/support/v7/widget/dk;->e(II)I
    ...
    .line 283
    invoke-virtual {p1, v4, v1}, Landroid/support/v7/widget/dk;->e(II)I
    ...
    .line 286
    iget-object v5, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/cp;

    invoke-virtual {v5, v3, v4}, Landroid/support/v7/widget/cp;->b(II)V
    ...
    .line 290
    :cond_5
    iget-object v3, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/cp;

    invoke-virtual {v3, p2, v2}, Landroid/support/v7/widget/cp;->a(II)V

    .line 293
    :cond_6
    sget p2, Landroid/support/v7/a/k;->Toolbar_contentInsetStartWithNavigation:I
    ...
    .line 295
    sget p2, Landroid/support/v7/a/k;->Toolbar_contentInsetEndWithActions:I
    ...
    .line 298
    sget p2, Landroid/support/v7/a/k;->Toolbar_collapseIcon:I
    ...
    .line 299
    sget p2, Landroid/support/v7/a/k;->Toolbar_collapseContentDescription:I

    invoke-virtual {p1, p2}, Landroid/support/v7/widget/dk;->c(I)Ljava/lang/CharSequence;
    ...
    .line 301
    sget p2, Landroid/support/v7/a/k;->Toolbar_title:I
    ...
    .line 306
    :cond_7
    sget p2, Landroid/support/v7/a/k;->Toolbar_subtitle:I
    ...
    .line 313
    sget p2, Landroid/support/v7/a/k;->Toolbar_popupTheme:I
    ...
    .line 315
    sget p2, Landroid/support/v7/a/k;->Toolbar_navigationIcon:I
    ...
    .line 319
    :cond_9
    sget p2, Landroid/support/v7/a/k;->Toolbar_navigationContentDescription:I
    ...
    .line 324
    :cond_a
    sget p2, Landroid/support/v7/a/k;->Toolbar_logo:I
    ...
    .line 329
    :cond_b
    sget p2, Landroid/support/v7/a/k;->Toolbar_logoDescription:I
    ...
    .line 334
    :cond_c
    sget p2, Landroid/support/v7/a/k;->Toolbar_titleTextColor:I
    ...
    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/dk;->b(II)I
    ...
    .line 338
    :cond_d
    sget p2, Landroid/support/v7/a/k;->Toolbar_subtitleTextColor:I
...
.method private a(Landroid/view/View;I)I
    ...
    .line 1970
    :goto_0
    iget v2, v0, Landroid/support/v7/widget/dp;->gravity:I
    ...
    .line 1985
    iget v5, v0, Landroid/support/v7/widget/dp;->topMargin:I

    if-ge v4, v5, :cond_1

    .line 1986
    iget v4, v0, Landroid/support/v7/widget/dp;->topMargin:I
    ...
    .line 1990
    iget p1, v0, Landroid/support/v7/widget/dp;->bottomMargin:I
...
.method private a(Landroid/view/View;I[II)I
    ...
    .line 1949
    iget p1, v0, Landroid/support/v7/widget/dp;->rightMargin:I
...
.method private a(Ljava/util/List;[I)I
    ...
    check-cast v6, Landroid/support/v7/widget/dp;

    .line 1929
    iget v7, v6, Landroid/support/v7/widget/dp;->leftMargin:I

    sub-int/2addr v7, v1

    .line 1930
    iget v1, v6, Landroid/support/v7/widget/dp;->rightMargin:I
...
.method private a(Landroid/view/View;Z)V
    ...
    .line 1392
    invoke-virtual {p0}, Landroid/support/v7/widget/Toolbar;->k()Landroid/support/v7/widget/dp;
    ...
    .line 1394
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/dp;
...
.method private a(Ljava/util/List;I)V
    ...
    .line 2018
    invoke-static {p0}, Landroid/support/v4/view/ab;->c(Landroid/view/View;)I
    ...
    .line 2020
    invoke-static {p2, v4}, Landroid/support/v4/view/j;->a(II)I
    ...
    .line 2029
    iget v2, v1, Landroid/support/v7/widget/dp;->a:I
    ...
    iget v1, v1, Landroid/support/v7/widget/dp;->gravity:I
    ...
    .line 2038
    iget v4, v2, Landroid/support/v7/widget/dp;->a:I
    ...
    iget v2, v2, Landroid/support/v7/widget/dp;->gravity:I
...
.method private b(Landroid/view/View;)I
    ...
    .line 2066
    invoke-static {p1}, Landroid/support/v4/view/n;->a(Landroid/view/ViewGroup$MarginLayoutParams;)I

    move-result v0

    .line 2067
    invoke-static {p1}, Landroid/support/v4/view/n;->b(Landroid/view/ViewGroup$MarginLayoutParams;)I
...
.method private b(Landroid/view/View;I[II)I
    ...
    .line 1956
    iget v1, v0, Landroid/support/v7/widget/dp;->rightMargin:I
    ...
    .line 1962
    iget p1, v0, Landroid/support/v7/widget/dp;->leftMargin:I
...
.method private o()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ActionMenuView;->d()Landroid/support/v7/view/menu/p;
    ...
    .line 1036
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->K:Landroid/support/v7/widget/do;

    if-nez v1, :cond_0

    .line 1037
    new-instance v1, Landroid/support/v7/widget/do;

    invoke-direct {v1, p0}, Landroid/support/v7/widget/do;-><init>(Landroid/support/v7/widget/Toolbar;)V

    iput-object v1, p0, Landroid/support/v7/widget/Toolbar;->K:Landroid/support/v7/widget/do;
...
.method private p()V
    ...
    iput v1, v0, Landroid/support/v7/widget/dp;->gravity:I
...
.method private t()V
    ...
    .line 2167
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/cp;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/cp;
...
# virtual methods
.method public a(Landroid/util/AttributeSet;)Landroid/support/v7/widget/dp;
    .locals 2
    ...
    invoke-direct {v0, v1, p1}, Landroid/support/v7/widget/dp;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-object v0
.end method

.method protected a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/dp;
    .locals 1
    ...
    check-cast p1, Landroid/support/v7/widget/dp;

    invoke-direct {v0, p1}, Landroid/support/v7/widget/dp;-><init>(Landroid/support/v7/widget/dp;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v7/widget/dp;-><init>(Landroid/support/v7/app/ActionBar$LayoutParams;)V
...
.method public a(II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/cp;->a(II)V
...
.method public a(Landroid/support/v7/view/menu/ag;Landroid/support/v7/view/menu/q;)V
    .locals 1

    .line 2159
    iput-object p1, p0, Landroid/support/v7/widget/Toolbar;->L:Landroid/support/v7/view/menu/ag;

    .line 2160
    iput-object p2, p0, Landroid/support/v7/widget/Toolbar;->M:Landroid/support/v7/view/menu/q;
...
.method public a(Landroid/support/v7/view/menu/p;Landroid/support/v7/widget/ActionMenuPresenter;)V
    .locals 3
    ...
    .line 561
    :cond_2
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->K:Landroid/support/v7/widget/do;
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/do;-><init>(Landroid/support/v7/widget/Toolbar;)V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->K:Landroid/support/v7/widget/do;
    ...
    invoke-virtual {p2, p1, v1}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Landroid/content/Context;Landroid/support/v7/view/menu/p;)V

    .line 571
    iget-object p1, p0, Landroid/support/v7/widget/Toolbar;->K:Landroid/support/v7/widget/do;

    iget-object v2, p0, Landroid/support/v7/widget/Toolbar;->l:Landroid/content/Context;

    invoke-virtual {p1, v2, v1}, Landroid/support/v7/widget/do;->a(Landroid/content/Context;Landroid/support/v7/view/menu/p;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/do;->b(Z)V
...
.method protected checkLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Z
    ...
    instance-of p1, p1, Landroid/support/v7/widget/dp;
...
.method public synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 141
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/Toolbar;->a(Landroid/util/AttributeSet;)Landroid/support/v7/widget/dp;
...
.method protected synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 141
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/Toolbar;->a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/dp;
...
.method public getContentInsetEnd()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/cp;->d()I
...
.method public getContentInsetStart()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/cp;->c()I
...
.method public getWrapper()Landroid/support/v7/widget/bq;
    .locals 2

    .line 2110
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/ds;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/ds;-><init>(Landroid/support/v7/widget/Toolbar;Z)V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/ds;
...
.method public h()Z
    ...
    iget-object v0, v0, Landroid/support/v7/widget/do;->b:Landroid/support/v7/view/menu/t;
...
.method j()V
    ...
    invoke-direct {v1, p0}, Landroid/support/v7/widget/dn;-><init>(Landroid/support/v7/widget/Toolbar;)V
...
.method protected k()Landroid/support/v7/widget/dp;
    .locals 2
    ...
    invoke-direct {v0, v1, v1}, Landroid/support/v7/widget/dp;-><init>(II)V
...
.method l()V
    ...
    .line 2122
    iget v2, v2, Landroid/support/v7/widget/dp;->a:I
...
.method protected onLayout(ZIIII)V
    ...
    .line 1718
    invoke-static/range {p0 .. p0}, Landroid/support/v4/view/ab;->d(Landroid/view/View;)I
    ...
    check-cast v15, Landroid/support/v7/widget/dp;

    .line 1783
    iget v3, v15, Landroid/support/v7/widget/dp;->topMargin:I
    ...
    iget v7, v15, Landroid/support/v7/widget/dp;->bottomMargin:I
    ...
    check-cast v7, Landroid/support/v7/widget/dp;

    .line 1787
    iget v15, v7, Landroid/support/v7/widget/dp;->topMargin:I
    ...
    iget v4, v7, Landroid/support/v7/widget/dp;->bottomMargin:I
    ...
    check-cast v4, Landroid/support/v7/widget/dp;
    ...
    .line 1807
    iget v12, v4, Landroid/support/v7/widget/dp;->topMargin:I
    ...
    .line 1808
    iget v2, v4, Landroid/support/v7/widget/dp;->topMargin:I
    ...
    .line 1812
    iget v2, v4, Landroid/support/v7/widget/dp;->bottomMargin:I
    ...
    .line 1813
    iget v2, v7, Landroid/support/v7/widget/dp;->bottomMargin:I
    ...
    iget v3, v4, Landroid/support/v7/widget/dp;->topMargin:I
    ...
    .line 1837
    iget v1, v1, Landroid/support/v7/widget/dp;->bottomMargin:I
    ...
    .line 1841
    iget v3, v1, Landroid/support/v7/widget/dp;->topMargin:I
    ...
    .line 1868
    iget v4, v1, Landroid/support/v7/widget/dp;->topMargin:I
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v1, v1, Landroid/support/v7/widget/do;->b:Landroid/support/v7/view/menu/t;
...
.method public setOnMenuItemClickListener(Landroid/support/v7/widget/dq;)V
    .locals 0

    .line 1082
    iput-object p1, p0, Landroid/support/v7/widget/Toolbar;->d:Landroid/support/v7/widget/dq;
