...
# static fields
.field static final i:Landroid/support/v7/widget/cw;
...
.field private l:Landroid/support/v7/widget/dc;
...
.field private x:Landroid/support/v7/widget/cy;

.field private y:Landroid/support/v7/widget/cx;

.field private z:Landroid/support/v7/widget/cz;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/SearchView;->i:Landroid/support/v7/widget/cw;
...
.method private p()V
    ...
    invoke-direct {v0, v1, p0, v3, v4}, Landroid/support/v7/widget/dd;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V
    ...
    :cond_2
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/dd;->a(I)V
...
.method public clearFocus()V
    ...
    .line 496
    invoke-super {p0}, Landroid/support/v7/widget/cb;->clearFocus()V
...
.method d()V
    ...
    .line 1188
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->x:Landroid/support/v7/widget/cy;
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/widget/cy;->a(Ljava/lang/String;)Z
...
.method e()V
    ...
    .line 1208
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->y:Landroid/support/v7/widget/cx;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->y:Landroid/support/v7/widget/cx;

    invoke-interface {v0}, Landroid/support/v7/widget/cx;->a()Z
...
.method h()V
    ...
    .line 1695
    sget-object v0, Landroid/support/v7/widget/SearchView;->i:Landroid/support/v7/widget/cw;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->a:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cw;->a(Landroid/widget/AutoCompleteTextView;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cw;->b(Landroid/widget/AutoCompleteTextView;)V
...
.method protected onLayout(ZIIII)V
    ...
    .line 838
    iget-object p1, p0, Landroid/support/v7/widget/SearchView;->l:Landroid/support/v7/widget/dc;

    if-nez p1, :cond_0

    .line 839
    new-instance p1, Landroid/support/v7/widget/dc;
    ...
    invoke-direct {p1, p2, p3, p4}, Landroid/support/v7/widget/dc;-><init>(Landroid/graphics/Rect;Landroid/graphics/Rect;Landroid/view/View;)V

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->l:Landroid/support/v7/widget/dc;
    ...
    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/dc;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1352
    invoke-super {p0, p1}, Landroid/support/v7/widget/cb;->onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-super {p0, v0}, Landroid/support/v7/widget/cb;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .line 1343
    invoke-super {p0}, Landroid/support/v7/widget/cb;->onSaveInstanceState()Landroid/os/Parcelable;
...
.method public onWindowFocusChanged(Z)V
    ...
    .line 1267
    invoke-super {p0, p1}, Landroid/support/v7/widget/cb;->onWindowFocusChanged(Z)V
...
.method public requestFocus(ILandroid/graphics/Rect;)Z
    ...
    .line 489
    :cond_3
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/cb;->requestFocus(ILandroid/graphics/Rect;)Z
...
.method public setOnCloseListener(Landroid/support/v7/widget/cx;)V
    .locals 0

    .line 518
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->y:Landroid/support/v7/widget/cx;
...
.method public setOnQueryTextListener(Landroid/support/v7/widget/cy;)V
    .locals 0

    .line 509
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->x:Landroid/support/v7/widget/cy;
...
.method public setOnSuggestionListener(Landroid/support/v7/widget/cz;)V
    .locals 0

    .line 536
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->z:Landroid/support/v7/widget/cz;
...
.method public setQueryRefinementEnabled(Z)V
    ...
    instance-of v0, v0, Landroid/support/v7/widget/dd;
    ...
    :goto_0
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/dd;->a(I)V
