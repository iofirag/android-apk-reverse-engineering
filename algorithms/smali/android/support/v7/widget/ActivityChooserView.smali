...
# instance fields
.field final a:Landroid/support/v7/widget/ad;
...
.field private n:Landroid/support/v7/widget/cd;
...
.method a(I)V
    ...
    .line 384
    :goto_1
    invoke-virtual {p0}, Landroid/support/v7/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/cd;

    move-result-object p1

    .line 385
    invoke-virtual {p1}, Landroid/support/v7/widget/cd;->e()Z
    ...
    invoke-virtual {v0, v1, v1}, Landroid/support/v7/widget/ad;->a(ZZ)V
    ...
    invoke-virtual {v3, v2, v0}, Landroid/support/v7/widget/ad;->a(ZZ)V
    ...
    .line 392
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/cd;->g(I)V

    .line 393
    invoke-virtual {p1}, Landroid/support/v7/widget/cd;->a()V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/g;->a(Z)V

    .line 397
    :cond_5
    invoke-virtual {p1}, Landroid/support/v7/widget/cd;->g()Landroid/widget/ListView;
    ...
    sget v3, Landroid/support/v7/a/i;->abc_activitychooserview_choose_application:I
...
.method getListPopupWindow()Landroid/support/v7/widget/cd;
    .locals 2

    .line 522
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/cd;
    ...
    invoke-direct {v0, v1}, Landroid/support/v7/widget/cd;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/cd;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cd;->a(Landroid/widget/ListAdapter;)V

    .line 525
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/cd;

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/cd;->b(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cd;->a(Z)V

    .line 527
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/cd;

    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->i:Landroid/support/v7/widget/ae;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cd;->a(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/cd;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method public setActivityChooserModel(Landroid/support/v7/widget/x;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ad;->a(Landroid/support/v7/widget/x;)V
...
.method public setProvider(Landroid/support/v4/view/g;)V
    .locals 0
