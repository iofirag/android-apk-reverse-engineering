...
.field protected f:Landroid/support/v4/view/av;
...
.method constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p2, p0}, Landroid/support/v7/widget/b;-><init>(Landroid/support/v7/widget/a;)V

    iput-object p2, p0, Landroid/support/v7/widget/a;->a:Landroid/support/v7/widget/b;
    ...
    sget v0, Landroid/support/v7/a/b;->actionBarPopupTheme:I
...
.method public a(IJ)Landroid/support/v4/view/av;
    ...
    .line 157
    iget-object v0, p0, Landroid/support/v7/widget/a;->f:Landroid/support/v4/view/av;
    ...
    .line 165
    :cond_1
    invoke-static {p0}, Landroid/support/v4/view/ab;->e(Landroid/view/View;)Landroid/support/v4/view/av;
    ...
    .line 167
    iget-object p2, p0, Landroid/support/v7/widget/a;->a:Landroid/support/v7/widget/b;

    invoke-virtual {p2, v0, p1}, Landroid/support/v7/widget/b;->a(Landroid/support/v4/view/av;I)Landroid/support/v7/widget/b;

    move-result-object p1

    invoke-virtual {v0, p1}, Landroid/support/v4/view/av;->a(Landroid/support/v4/view/az;)Landroid/support/v4/view/av;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/view/av;->a(F)Landroid/support/v4/view/av;
