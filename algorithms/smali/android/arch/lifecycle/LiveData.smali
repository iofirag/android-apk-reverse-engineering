...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Landroid/arch/lifecycle/p;-><init>(Landroid/arch/lifecycle/LiveData;)V
...
.method static synthetic access$400(Landroid/arch/lifecycle/LiveData;Landroid/arch/lifecycle/r;)V
    .locals 0

    .line 59
    invoke-direct {p0, p1}, Landroid/arch/lifecycle/LiveData;->dispatchingValue(Landroid/arch/lifecycle/r;)V
...
.method private considerNotify(Landroid/arch/lifecycle/r;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroid/arch/lifecycle/LiveData<",
            "TT;>.android/arch/lifecycle/r;)V"
        }
    .end annotation

    .line 92
    iget-boolean v0, p1, Landroid/arch/lifecycle/r;->d:Z
    ...
    .line 100
    :cond_0
    invoke-virtual {p1}, Landroid/arch/lifecycle/r;->a()Z
    ...
    .line 101
    invoke-virtual {p1, v0}, Landroid/arch/lifecycle/r;->a(Z)V

    return-void

    .line 104
    :cond_1
    iget v0, p1, Landroid/arch/lifecycle/r;->e:I
    ...
    iput v0, p1, Landroid/arch/lifecycle/r;->e:I

    .line 109
    iget-object p1, p1, Landroid/arch/lifecycle/r;->c:Landroid/arch/lifecycle/u;

    iget-object v0, p0, Landroid/arch/lifecycle/LiveData;->mData:Ljava/lang/Object;

    invoke-interface {p1, v0}, Landroid/arch/lifecycle/u;->onChanged(Ljava/lang/Object;)V

    return-void
.end method

.method private dispatchingValue(Landroid/arch/lifecycle/r;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 121
    invoke-direct {p0, p1}, Landroid/arch/lifecycle/LiveData;->considerNotify(Landroid/arch/lifecycle/r;)V
    ...
    .line 125
    invoke-virtual {v1}, Landroid/arch/a/b/b;->c()Landroid/arch/a/b/g;
    ...
    invoke-direct {p0, v2}, Landroid/arch/lifecycle/LiveData;->considerNotify(Landroid/arch/lifecycle/r;)V
...
.method public observe(Landroid/arch/lifecycle/j;Landroid/arch/lifecycle/u;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1, p2}, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;-><init>(Landroid/arch/lifecycle/LiveData;Landroid/arch/lifecycle/j;Landroid/arch/lifecycle/u;)V
    ...
    check-cast p2, Landroid/arch/lifecycle/r;

    if-eqz p2, :cond_1

    .line 172
    invoke-virtual {p2, p1}, Landroid/arch/lifecycle/r;->a(Landroid/arch/lifecycle/j;)Z
    ...
    invoke-virtual {p1, v0}, Landroid/arch/lifecycle/f;->a(Landroid/arch/lifecycle/i;)V

    return-void
.end method

.method public observeForever(Landroid/arch/lifecycle/u;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1}, Landroid/arch/lifecycle/q;-><init>(Landroid/arch/lifecycle/LiveData;Landroid/arch/lifecycle/u;)V
    ...
    .line 207
    invoke-virtual {v0, p1}, Landroid/arch/lifecycle/q;->a(Z)V
...
.method public removeObservers(Landroid/arch/lifecycle/j;)V
    .locals 3
    ...
    invoke-virtual {v2, p1}, Landroid/arch/lifecycle/r;->a(Landroid/arch/lifecycle/j;)Z
    ...
    invoke-virtual {p0, v1}, Landroid/arch/lifecycle/LiveData;->removeObserver(Landroid/arch/lifecycle/u;)V
