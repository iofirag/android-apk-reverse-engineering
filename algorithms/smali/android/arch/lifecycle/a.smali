...
.method private a(Ljava/lang/Class;[Ljava/lang/reflect/Method;)Landroid/arch/lifecycle/b;
    .locals 11
    ...
    .line 109
    iget-object v0, v0, Landroid/arch/lifecycle/b;->b:Ljava/util/Map;
    ...
    iget-object v5, v5, Landroid/arch/lifecycle/b;->b:Ljava/util/Map;
    ...
    invoke-direct {p0, v1, v7, v6, p1}, Landroid/arch/lifecycle/a;->a(Ljava/util/Map;Landroid/arch/lifecycle/c;Landroid/arch/lifecycle/g;Ljava/lang/Class;)V
    ...
    .line 124
    const-class v6, Landroid/arch/lifecycle/v;

    invoke-virtual {v5, v6}, Ljava/lang/reflect/Method;->getAnnotation(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;

    move-result-object v6

    check-cast v6, Landroid/arch/lifecycle/v;
    ...
    const-class v9, Landroid/arch/lifecycle/j;
    ...
    .line 138
    :goto_4
    invoke-interface {v6}, Landroid/arch/lifecycle/v;->a()Landroid/arch/lifecycle/g;
    ...
    .line 146
    :cond_7
    sget-object v8, Landroid/arch/lifecycle/g;->ON_ANY:Landroid/arch/lifecycle/g;
    ...
    .line 155
    invoke-direct {p0, v1, v4, v6, p1}, Landroid/arch/lifecycle/a;->a(Ljava/util/Map;Landroid/arch/lifecycle/c;Landroid/arch/lifecycle/g;Ljava/lang/Class;)V
...
.method private a(Ljava/util/Map;Landroid/arch/lifecycle/c;Landroid/arch/lifecycle/g;Ljava/lang/Class;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 92
    iget-object p1, p2, Landroid/arch/lifecycle/c;->b:Ljava/lang/reflect/Method;
...
.method a(Ljava/lang/Class;)Z
    ...
    check-cast v4, Landroid/arch/lifecycle/v;

    if-eqz v4, :cond_1

    .line 59
    invoke-direct {p0, p1, v0}, Landroid/arch/lifecycle/a;->a(Ljava/lang/Class;[Ljava/lang/reflect/Method;)Landroid/arch/lifecycle/b;
...
.method b(Ljava/lang/Class;)Landroid/arch/lifecycle/b;
    .locals 1
